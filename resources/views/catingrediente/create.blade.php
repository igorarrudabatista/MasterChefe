    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Cadastro da Categoria / Tipo de ingredientes</h3>
                <p class="text-subtitle text-muted">Theaare's a lot of form layout that you can use</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Painel</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Cadastro de Categoria / Tipo de ingredientes</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="text-center mb-5">
                    ...
                    <h3>Cadastro de Categorias de ing</h3>
                    <p></p>
                </div>
