...
<td> Nota Seduc: <h3 class="text-green">    {{$totalnotasseduc ?? 'Nota não informada'}} </h3> </td>
@elseif ($totalnotasseduc <= 6)
<td>Nota Seduc:  <h3 class="text-red">  {{$totalnotasseduc ?? 'Nota não informada'}} </h3> </td>
@endif

@if ($totalnotasdre >= 6)
<td> Nota DRE: <h3 class="text-green">    {{$totalnotasdre ?? 'Nota não informada'}} </h3> </td>
@elseif ($totalnotasdre <= 6)
<td>Nota DRE:  <h3 class="text-red">  {{$totalnotasdre ?? 'Nota não informada'}} </h3> </td>
@endif
<td> TOTAL <h3 class="text-green"> {{$totalnotasseduc + $totalnotasdre ?? 'Nota não informada'}} </h3> </td>
<td>
  @switch($recibos)
