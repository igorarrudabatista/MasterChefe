...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>LISTA DE INSCRITOS da DRE Primavera do Leste</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Início</a></li>
        <li class="breadcrumb-item ">Lista de Inscritos</li>
        <li class="breadcrumb-item active ">DRE Primavera do Leste</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  <div class="card">
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Lista de Inscritos - DRE Primavera do Leste</h5>
