...
@endif
  <div class="login-container">
   <center> <img src="{{asset('images/logo_seduc_chef.jpg')}}" alt="" srcset="">
    ...
    {!! Form::open(array('route' => 'Site.store_formulario','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
...
<div class="alert alert-success" role="alert">
 ...
 <center>
    <div class="checkbox-group">
        <input type="checkbox" id="terms-and-privacy" name="terms-and-privacy" value="Terms-and-Privacy" >
